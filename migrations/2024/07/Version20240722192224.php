...
final class Version20240722192224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conversation.conversation (id UUID NOT NULL, user_id VARCHAR(20) NOT NULL, action_route VARCHAR(255) NOT NULL, play_load TEXT NOT NULL, PRIMARY KEY(id))');
