...
final class Version20240903102626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carrier.delivery (id UUID NOT NULL, parcel_id UUID NOT NULL, carrier_id VARCHAR(20) NOT NULL, status VARCHAR(255) NOT NULL, create_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
